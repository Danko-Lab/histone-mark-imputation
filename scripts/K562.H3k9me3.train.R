...
file.bw.histone <- file.H3k9me3.bw;
file.peak.histone <- file.H3k9me3.peak;
...
model <- svm_train_model(model, gdm, "../models/H3k9me3.train.rdata", ncores=15);
save(model, file="../models/H3k9me3.train.rdata");
