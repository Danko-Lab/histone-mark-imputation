...
file.bw.histone <- file.H3k122ac.bw;
file.peak.histone <- file.H3k122ac.peak;
...
model <- svm_train_model(model, gdm, "../models/H3k122ac.train.rdata", ncores=15);
save(model, file="../models/H3k122ac.train.rdata");
