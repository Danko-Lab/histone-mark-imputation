...
file.bw.histone <- file.H4k20me1.bw;
file.peak.histone <- file.H4k20me1.peak;
...
model <- svm_train_model(model, gdm, "../models/H4k20me1.train.rdata", ncores=15);
save(model, file="../models/H4k20me1.train.rdata");
