...
file.rdata.model <- "../models/Atac.exlchr22.k562.S1.train.rdata"
path.proseq <- ""
...
pred <- svm_predict_chr_parallel( "ATAC.exlchr22.K562.S1", file.bws.plus[1], file.bws.minus[1], file.rdata.model, chr="chr22", bigwig_compare=file.bw.histone, ncores=5, linear_scale=F, gpu.idx=1  )
