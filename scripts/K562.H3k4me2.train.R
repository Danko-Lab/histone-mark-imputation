...
file.bw.histone <- file.H3k4me2.bw;
file.peak.histone <- file.H3k4me2.peak;
...
model <- svm_train_model(model, gdm, "../models/H3k4me2.S1.train.rdata", ncores=15);
save(model, file="../models/H3k4me2.S1.train.rdata");
