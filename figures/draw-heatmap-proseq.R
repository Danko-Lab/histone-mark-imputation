...
if(1)
{
    ...
    file.plus.bw <- "../pred-alex/Alex.Proseq.Merge.5end.plus.bw"
    file.minus.bw <- "../pred-alex/Alex.Proseq.Merge.5end.minus.bw"

    sup <- writeProseqHeatmap( bed.Tss, file.plus.bw, file.minus.bw, "Alex-5end-Proseq")

    file.plus.bw <- "../pred-alex/Alex.Proseq.Merge.3end.plus.bw"
    file.minus.bw <- "../pred-alex/Alex.Proseq.Merge.3end.minus.bw"

    sup <- writeProseqHeatmap( bed.Tss, file.plus.bw, file.minus.bw, "Alex-3end-Proseq")
}
